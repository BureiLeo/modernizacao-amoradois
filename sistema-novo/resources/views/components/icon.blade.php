@php
/**
 * Icones Lucide (lucide.dev, licenca ISC) embutidos como SVG inline.
 * Evita adicionar uma dependencia JS so para icones (Etapa 5 #11: "Usar
 * Lucide Icons. Nao misturar varias bibliotecas de icone.") - mantendo o
 * conjunto minimo realmente usado pela navegacao/dashboard.
 *
 * Uso: <x-icon name="layout-dashboard" class="w-5 h-5" />
 */
$paths = [
